...
maps.n["<leader>c"] = {
	function()
		require("core.utils.buffer").close()
	end,
	desc = "Close buffer",
}
maps.n["<leader>C"] = {
	function()
		require("core.utils.buffer").close(0, true)
	end,
...
maps.n[">b"] = {
	function()
		require("core.utils.buffer").move(vim.v.count > 0 and vim.v.count or 1)
	end,
...
maps.n["<leader>bC"] = {
	function()
		require("core.utils.buffer").close_all()
	end,
